...
def get_transcript_azure(
    wav_path: str, speech_key: str, service_region: str, out_dir: Optional[str] = None
) -> str:
    """
    ...
    if out_dir is not None:
        with open(
            os.path.join(out_dir, os.path.basename(wav_path).replace(".wav", ".txt")),
            "w",
        ) as f:
